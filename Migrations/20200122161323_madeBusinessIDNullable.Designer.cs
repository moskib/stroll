...
namespace Stroll.Migrations
{
    ...
    [Migration("20200122161323_madeBusinessIDNullable")]
    partial class madeBusinessIDNullable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Stroll.Models.Usertypes", b =>
                {
                    b.Property<int>("UID")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("uid")
            ...
            modelBuilder.Entity("Stroll.Models.User", b =>
                {
                    b.HasOne("Stroll.Models.Usertypes", "UserType")
                        .WithMany()
                        .HasForeignKey("Type")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
